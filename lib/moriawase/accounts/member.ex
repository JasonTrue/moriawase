defmodule Moriawase.Accounts.Member do
  use Moriawase.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Moriawase.Repo)
  ...
  """
  def valid_password?(%Moriawase.Accounts.Member{hashed_password: hashed_password}, password)
