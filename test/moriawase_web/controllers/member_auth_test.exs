defmodule MoriawaseWeb.MemberAuthTest do
  use MoriawaseWeb.ConnCase, async: true

  alias Moriawase.Accounts
  alias MoriawaseWeb.MemberAuth
  import Moriawase.AccountsFixtures

  @remember_me_cookie "_moriawase_web_member_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MoriawaseWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_member/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MoriawaseWeb.Endpoint.subscribe(live_socket_id)
